...
func createTransactionsBuilder(htBuilderFactory hashtrees.HashTreeBuilderFactory, metBuilderFactory metadata.BuilderFactory) signed_transactions.TransactionsBuilder {
