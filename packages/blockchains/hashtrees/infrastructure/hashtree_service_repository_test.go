...
func TestSaveHashTree_thenRetrieve_Success(t *testing.T) {
	...
	htBuilderFactory := CreateHashTreeBuilderFactory()
	...
	//execute:
	service := CreateHashTreeService(fileService, fileBuilderFactory)
	repository := CreateHashTreeRepository(fileRepository)
