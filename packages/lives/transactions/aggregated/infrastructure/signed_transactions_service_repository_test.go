...
func TestSaveSignedTrs_thenRetrieve_Success(t *testing.T) {
	...
	aggregatedTrsRepository := CreateTransactionsRepository(signedTrsRepository, atomicTrsRepository, htRepository, objectRepository, aggregatedTrsBuilderFactory)
	aggregatedTrsService := CreateTransactionsService(signedTrsService, atomicTrsService, htService, metaDataBuilderFactory, objectService, objBuilderFactory, storedTreeBuilderFactory, storedTreesBuilderFactory)
	...
	//execute:
	repository := CreateSignedTransactionsRepository(objectRepository, aggregatedTrsRepository, aggregatedSignedTrsBuilderFactory)
	service := CreateSignedTransactionsService(metaDataBuilderFactory, objBuilderFactory, objectService, aggregatedTrsService, storedTreeBuilderFactory)
